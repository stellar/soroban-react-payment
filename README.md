...
2. Clone and navigate into the [Payment DApp repository](https://github.com/stellar/soroban-react-payment/tree/main) by trunning the following:
...
4. Install the dependencies by running the following:

    ```
    yarn
    ```

5. Connect your Freighter wallet to the DApp and ensure that experimental mode is enabled.
